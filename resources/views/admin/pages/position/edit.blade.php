                ...
                <form action="{{route('admin.position.update')}}" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="posname" value="{{$position->position_name}}" name="posname"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="{{$position->max_vote}}" id="maxvote" name="maxvote"
                    ...
                    <div class="box-footer">
                        <a href="/admin/position/view" class="btn btn-danger">Cancel</a>
